	...
	"plugins": [
		{
			"name": "mangaread_org",
			"urls": {
        "windows": upload_to_catbox_with_curl(build_windows(f"{current_path}/mangaread_org")),
        "linux": upload_to_catbox_with_curl(build_linux(f"{current_path}/mangaread_org"))
      },
			"version": get_plugin_version(f"{current_path}/mangaread_org"),
			"state": "updated",
			"build_state": get_build_state(f"{current_path}/mangaread_org"),
		},
	]
}
