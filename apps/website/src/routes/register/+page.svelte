...
<div class="flex h-full w-full flex-col items-center justify-center p-4">
	<div
		class="card preset-filled-surface-100-900 border-surface-200-800 card-hover divide-surface-200-800 h-5/10 w-4/10 flex flex-col items-center justify-center gap-8 overflow-hidden border-[1px]"
	>
		...
		<article class="flex flex-col items-center justify-center space-y-4 p-4">
			...
			>
				...
				{#if !submitting}
					<button type="submit" class="btn preset-filled">Register</button>
				{:else}
