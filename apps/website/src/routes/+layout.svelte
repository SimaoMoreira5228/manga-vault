<script lang="ts">
	...
	import { BookOpenText, Folder, Search, Menu, Sun, Moon } from '@lucide/svelte';
...
<div class="h-screen w-screen">
	<div
		class="card border-surface-100-900 hidden h-full w-full grid-cols-[auto_1fr] border-[1px] md:grid"
	>
	...
	<div
		class="card border-surface-100-900 grid h-full w-full grid-rows-[1fr_auto] border-[1px] md:hidden"
	>
		<div class="h-full min-h-0 w-full overflow-auto">
			{@render children?.()}
		</div>
