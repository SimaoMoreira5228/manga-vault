...
export type ChapterMutation = {
	...
	readAllChapters: Scalars["Boolean"]["output"];
	readChapter: ReadChapter;
	unreadAllChapters: Scalars["Boolean"]["output"];
	unreadChapter: Scalars["Boolean"]["output"];
};

export type ChapterMutationReadAllChaptersArgs = {
...
export type ChapterMutationUnreadAllChaptersArgs = {
	mangaId: Scalars["Int"]["input"];
};
...
export type MeQuery = {
	...
	users: {
		__typename?: "UserQuery";
		me?: { __typename?: "User"; id: number; username: string; imageId?: number | null } | null;
	};
};
...
export type LoginMutation = {
	...
	auth: {
		__typename?: "AuthMutation";
		login: { __typename?: "User"; id: number; username: string; imageId?: number | null };
	};
};
...
export type RegisterMutation = {
	...
	auth: {
		__typename?: "AuthMutation";
		register: { __typename?: "User"; id: number; username: string; imageId?: number | null };
	};
};
...
export type MangaFieldsFragment = {
	__typename?: "Manga";
	id: number;
	title: string;
	url: string;
	...
	>;
	scraperInfo?: { __typename?: "Scraper"; id: string; name: string; imageUrl: string; refererUrl?: string | null } | null;
} & { " $fragmentName"?: "MangaFieldsFragment" };
...
export type GetFavoriteMangaQuery = {
	__typename?: "QueryRoot";
	favoriteMangas: {
		__typename?: "FavoriteMangaQuery";
		isUserFavorite: boolean;
		favoriteMangaByMangaId?: { __typename?: "FavoriteManga"; id: number; categoryId: number } | null;
	};
};

export type GetReadChaptersQueryVariables = Exact<{
	id: Scalars["Int"]["input"];
}>;

export type GetReadChaptersQuery = {
	__typename?: "QueryRoot";
	mangas: {
		__typename?: "MangaQuery";
		manga?: {
			...
			userReadChapters: Array<{ __typename?: "ReadChapter"; id: number; chapterId: number }>;
		} | null;
	};
};
...
export type CategoriesQuery = {
	__typename?: "QueryRoot";
	categories: { __typename?: "CategoryQuery"; userCategories: Array<{ __typename?: "Category"; id: number; name: string }> };
};
...
export type GetfavoriteMangasQuery = {
	__typename?: "QueryRoot";
	favoriteMangas: {
		__typename?: "FavoriteMangaQuery";
		userFavoriteMangas: Array<
			{
				__typename?: "FavoriteManga";
				id: number;
				manga: {
...
export type UpdateCategoryMutation = {
	__typename?: "MutationRoot";
	category: { __typename?: "CategoryMutation"; updateCategory: { __typename?: "Category"; id: number; name: string } };
};
...
export type DeleteCategoryMutation = {
	__typename?: "MutationRoot";
	category: { __typename?: "CategoryMutation"; deleteCategory: boolean };
};
...
export type CreateCategoryMutation = {
	__typename?: "MutationRoot";
	category: { __typename?: "CategoryMutation"; createCategory: { __typename?: "Category"; id: number; name: string } };
};
...
export type UnfavoriteMangaMutation = {
	__typename?: "MutationRoot";
	favoriteManga: { __typename?: "FavoriteMangaMutation"; deleteFavoriteManga: boolean };
};
...
export type FavoriteMangaMutation = {
	__typename?: "MutationRoot";
	favoriteManga: { __typename?: "FavoriteMangaMutation"; createFavoriteManga: { __typename?: "FavoriteManga"; id: number } };
};
...
export type ReadChapterMutation = {
	__typename?: "MutationRoot";
	chapter: { __typename?: "ChapterMutation"; readChapter: { __typename?: "ReadChapter"; id: number; chapterId: number } };
};
...
export type UnreadChapterMutation = {
	__typename?: "MutationRoot";
	chapter: { __typename?: "ChapterMutation"; unreadChapter: boolean };
};

export type ReadAllChaptersMutationVariables = Exact<{
	mangaId: Scalars["Int"]["input"];
}>;

export type ReadAllChaptersMutation = {
	__typename?: "MutationRoot";
	chapter: { __typename?: "ChapterMutation"; readAllChapters: boolean };
};

export type UnreadAllChaptersMutationVariables = Exact<{
	mangaId: Scalars["Int"]["input"];
}>;

export type UnreadAllChaptersMutation = {
	__typename?: "MutationRoot";
	chapter: { __typename?: "ChapterMutation"; unreadAllChapters: boolean };
};
...
export type GetChapterInfoQuery = {
	__typename?: "QueryRoot";
	chapters: {
		__typename?: "ChapterQuery";
		chapter?: {
			__typename?: "Chapter";
			images: Array<string>;
			nextChapter?: { __typename?: "Chapter"; id: number; title: string } | null;
			previousChapter?: { __typename?: "Chapter"; id: number } | null;
			scraper: { __typename?: "Scraper"; refererUrl?: string | null };
		} | null;
	};
};
...
export type GetUserFilesQuery = {
	__typename?: "QueryRoot";
	files: { __typename?: "FileQuery"; files: Array<{ __typename?: "File"; id: number }> };
};
...
export type UploadProfileFileMutation = {
	__typename?: "MutationRoot";
	files: { __typename?: "FileMutation"; uploadFile: { __typename?: "File"; id: number } };
};
...
export type UpdateProfileMutation = {
	__typename?: "MutationRoot";
	profile: { __typename?: "ProfileMutation"; updateProfile: { __typename?: "User"; id: number } };
};
...
export type GetSearchQuery = {
	...
	scraping: {
		__typename?: "ScrapingQuery";
		search: Array<{ __typename?: "Manga"; id: number; title: string; imgUrl: string }>;
	};
};

export type GetScrapersSearchQueryVariables = Exact<{ [key: string]: never }>;

export type GetScrapersSearchQuery = {
	__typename?: "QueryRoot";
	scraping: {
		__typename?: "ScrapingQuery";
		scrapers: Array<{ __typename?: "Scraper"; id: string; name: string; refererUrl?: string | null }>;
	};
};

export type GetScrapersQueryVariables = Exact<{ [key: string]: never }>;

export type GetScrapersQuery = {
	__typename?: "QueryRoot";
	scraping: {
		__typename?: "ScrapingQuery";
		scrapers: Array<{ __typename?: "Scraper"; id: string; name: string; imageUrl: string }>;
	};
};
...
export type GetScraperQuery = {
	__typename?: "QueryRoot";
	scraping: { __typename?: "ScrapingQuery"; scraper: { __typename?: "Scraper"; id: string; refererUrl?: string | null } };
};
...
export type GetLatestQuery = {
	...
	scraping: {
		__typename?: "ScrapingQuery";
		scrapeLatest: Array<{ __typename?: "Manga"; id: number; title: string; imgUrl: string }>;
	};
};
...
export type GetSearchScraperQuery = {
	__typename?: "QueryRoot";
	scraping: {
		__typename?: "ScrapingQuery";
		search: Array<{ __typename?: "Manga"; id: number; title: string; imgUrl: string }>;
...
export type GetTrendingQuery = {
	...
	scraping: {
		__typename?: "ScrapingQuery";
		scrapeTrending: Array<{ __typename?: "Manga"; id: number; title: string; imgUrl: string }>;
	};
};
...
export const MangaFieldsFragmentDoc = {
	...
	"definitions": [{
		...
		"name": { "kind": "Name", "value": "MangaFields" },
		"typeCondition": { "kind": "NamedType", "name": { "kind": "Name", "value": "Manga" } },
		"selectionSet": {
			"kind": "SelectionSet",
			"selections": [
				...
				{ "kind": "Field", "name": { "kind": "Name", "value": "scraper" } },
				{ "kind": "Field", "name": { "kind": "Name", "value": "createdAt" } },
				{ "kind": "Field", "name": { "kind": "Name", "value": "updatedAt" } },
				{ "kind": "Field", "name": { "kind": "Name", "value": "alternativeNames" } },
				{ "kind": "Field", "name": { "kind": "Name", "value": "authors" } },
				{ "kind": "Field", "name": { "kind": "Name", "value": "artists" } },
				{ "kind": "Field", "name": { "kind": "Name", "value": "status" } },
				{ "kind": "Field", "name": { "kind": "Name", "value": "mangaType" } },
				...
				{ "kind": "Field", "name": { "kind": "Name", "value": "genres" } },
				{
					...
					"selectionSet": {
						...
						"selections": [
							{ "kind": "Field", "name": { "kind": "Name", "value": "createdAt" } },
							{ "kind": "Field", "name": { "kind": "Name", "value": "id" } },
							{ "kind": "Field", "name": { "kind": "Name", "value": "scanlationGroup" } },
							{ "kind": "Field", "name": { "kind": "Name", "value": "title" } },
							{ "kind": "Field", "name": { "kind": "Name", "value": "updatedAt" } },
							{ "kind": "Field", "name": { "kind": "Name", "value": "url" } },
						],
				...
				{
					"kind": "Field",
					"name": { "kind": "Name", "value": "scraperInfo" },
					"selectionSet": {
						"kind": "SelectionSet",
						"selections": [
							{ "kind": "Field", "name": { "kind": "Name", "value": "id" } },
							...
							{ "kind": "Field", "name": { "kind": "Name", "value": "refererUrl" } },
						],
					},
				},
			],
...
} as unknown as DocumentNode<MangaFieldsFragment, unknown>;
...
export const GetMangaDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "getManga" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			...
			"selections": [{
				...
				"selectionSet": {
					...
					"selections": [{
						...
						"selectionSet": {
							"kind": "SelectionSet",
							"selections": [{ "kind": "FragmentSpread", "name": { "kind": "Name", "value": "MangaFields" } }],
						},
					}],
				},
			}],
...
} as unknown as DocumentNode<GetMangaQuery, GetMangaQueryVariables>;
export const GetFavoriteMangaDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		...
		"selectionSet": {
			...
			"selections": [{
				"kind": "Field",
				"name": { "kind": "Name", "value": "favoriteMangas" },
				"selectionSet": {
					"kind": "SelectionSet",
					"selections": [{
						"kind": "Field",
						...
						"kind": "Field",
						"name": { "kind": "Name", "value": "favoriteMangaByMangaId" },
						"arguments": [{
							"kind": "Argument",
							"name": { "kind": "Name", "value": "mangaId" },
							"value": { "kind": "Variable", "name": { "kind": "Name", "value": "id" } },
...
} as unknown as DocumentNode<GetFavoriteMangaQuery, GetFavoriteMangaQueryVariables>;
export const GetReadChaptersDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "getReadChapters" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "id" } },
			"type": { "kind": "NonNullType", "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "Int" } } },
			...
			"selections": [{
				...
				"selectionSet": {
					...
					"selections": [{
						...
						"selectionSet": {
							"kind": "SelectionSet",
							"selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "userReadChaptersAmount" } }, {
								"kind": "Field",
								"name": { "kind": "Name", "value": "chaptersAmount" },
							}, {
								"kind": "Field",
								"name": { "kind": "Name", "value": "userReadChapters" },
								"selectionSet": {
									"kind": "SelectionSet",
									"selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "id" } }, {
										"kind": "Field",
...
} as unknown as DocumentNode<GetReadChaptersQuery, GetReadChaptersQueryVariables>;
		...
		"selectionSet": {
			...
			"selections": [{
				...
				"selectionSet": {
					...
					"selections": [{
						"kind": "Field",
						"name": { "kind": "Name", "value": "userCategories" },
						"selectionSet": {
							"kind": "SelectionSet",
							"selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "id" } }, {
								"kind": "Field",
...
export const GetfavoriteMangasDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "getfavoriteMangas" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
		...
		"selectionSet": {
			...
			"selections": [{
				...
				"selectionSet": {
					...
					"selections": [{
						"kind": "Field",
						"name": { "kind": "Name", "value": "userFavoriteMangas" },
						"arguments": [{
							"kind": "Argument",
							"name": { "kind": "Name", "value": "categoryId" },
							...
							"selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "id" } }, {
								...
								"selectionSet": {
									...
									"selections": [
										...
										{ "kind": "Field", "name": { "kind": "Name", "value": "imgUrl" } },
										{ "kind": "Field", "name": { "kind": "Name", "value": "scraper" } },
										{ "kind": "Field", "name": { "kind": "Name", "value": "userReadChaptersAmount" } },
										{ "kind": "Field", "name": { "kind": "Name", "value": "chaptersAmount" } },
									],
								},
							}],
						},
...
} as unknown as DocumentNode<GetfavoriteMangasQuery, GetfavoriteMangasQueryVariables>;
...
export const UnfavoriteMangaDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "mutation",
		"name": { "kind": "Name", "value": "unfavoriteManga" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "id" } },
			"type": { "kind": "NonNullType", "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "Int" } } },
		...
		"selectionSet": {
			...
			"selections": [{
				"kind": "Field",
				"name": { "kind": "Name", "value": "favoriteManga" },
				"selectionSet": {
					"kind": "SelectionSet",
					"selections": [{
						"kind": "Field",
...
} as unknown as DocumentNode<UnfavoriteMangaMutation, UnfavoriteMangaMutationVariables>;
export const FavoriteMangaDocument = {
	...
	"definitions": [{
		...
		"variableDefinitions": [{
			...
			"type": {
				"kind": "NonNullType",
				"type": { "kind": "NamedType", "name": { "kind": "Name", "value": "CreateFavoriteMangaInput" } },
			},
		}],
		"selectionSet": {
			"kind": "SelectionSet",
			"selections": [{
				...
				"selectionSet": {
					...
					"selections": [{
						"kind": "Field",
						"name": { "kind": "Name", "value": "createFavoriteManga" },
						"arguments": [{
							"kind": "Argument",
							"name": { "kind": "Name", "value": "input" },
							"value": { "kind": "Variable", "name": { "kind": "Name", "value": "input" } },
...
} as unknown as DocumentNode<FavoriteMangaMutation, FavoriteMangaMutationVariables>;
export const ReadChapterDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "mutation",
		"name": { "kind": "Name", "value": "readChapter" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
...
} as unknown as DocumentNode<ReadChapterMutation, ReadChapterMutationVariables>;
export const UnreadChapterDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "mutation",
		"name": { "kind": "Name", "value": "unreadChapter" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "chapterId" } },
			"type": { "kind": "NonNullType", "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "Int" } } },
...
} as unknown as DocumentNode<UnreadChapterMutation, UnreadChapterMutationVariables>;
export const ReadAllChaptersDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "mutation",
		"name": { "kind": "Name", "value": "readAllChapters" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
...
} as unknown as DocumentNode<ReadAllChaptersMutation, ReadAllChaptersMutationVariables>;
export const UnreadAllChaptersDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "mutation",
		"name": { "kind": "Name", "value": "unreadAllChapters" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "mangaId" } },
			"type": { "kind": "NonNullType", "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "Int" } } },
...
} as unknown as DocumentNode<UnreadAllChaptersMutation, UnreadAllChaptersMutationVariables>;
export const GetChapterInfoDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "getChapterInfo" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "chapterId" } },
			"type": { "kind": "NonNullType", "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "Int" } } },
					...
					"selections": [{
						...
						"selectionSet": {
							...
							"selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "images" } }, {
								...
								"kind": "Field",
								"name": { "kind": "Name", "value": "previousChapter" },
								"selectionSet": {
									"kind": "SelectionSet",
									"selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "id" } }],
								},
								...
								"kind": "Field",
								"name": { "kind": "Name", "value": "scraper" },
								"selectionSet": {
									"kind": "SelectionSet",
									"selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "refererUrl" } }],
								},
							}],
						},
					}],
...
} as unknown as DocumentNode<GetChapterInfoQuery, GetChapterInfoQueryVariables>;
...
export const UploadProfileFileDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "mutation",
		"name": { "kind": "Name", "value": "uploadProfileFile" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
...
} as unknown as DocumentNode<UploadProfileFileMutation, UploadProfileFileMutationVariables>;
...
export const GetSearchDocument = {
	...
	"definitions": [{
		...
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "scraperId" } },
			...
			"selections": [{
				...
				"selectionSet": {
					...
					"selections": [{
						...
						"arguments": [{
							"kind": "Argument",
							"name": { "kind": "Name", "value": "scraperId" },
							"value": { "kind": "Variable", "name": { "kind": "Name", "value": "scraperId" } },
						}, {
							"kind": "Argument",
...
export const GetScrapersSearchDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "GetScrapersSearch" },
		"selectionSet": {
			"kind": "SelectionSet",
			"selections": [{
				"kind": "Field",
...
} as unknown as DocumentNode<GetScrapersSearchQuery, GetScrapersSearchQueryVariables>;
export const GetScrapersDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "GetScrapers" },
		"selectionSet": {
			"kind": "SelectionSet",
			"selections": [{
				"kind": "Field",
...
} as unknown as DocumentNode<GetScrapersQuery, GetScrapersQueryVariables>;
export const GetScraperDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "GetScraper" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "scraperId" } },
			"type": { "kind": "NonNullType", "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "String" } } },
				...
				"selectionSet": {
					...
					"selections": [{
						...
						"selectionSet": {
							...
							"selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "id" } }, {
								"kind": "Field",
								"name": { "kind": "Name", "value": "refererUrl" },
							}],
						},
					}],
				},
...
} as unknown as DocumentNode<GetScraperQuery, GetScraperQueryVariables>;
export const GetLatestDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "GetLatest" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "scraperId" } },
			"type": { "kind": "NonNullType", "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "String" } } },
		...
		"selectionSet": {
			...
			"selections": [{
				...
				"selectionSet": {
					...
					"selections": [{
						"kind": "Field",
						"name": { "kind": "Name", "value": "scrapeLatest" },
						"arguments": [{
							"kind": "Argument",
							"name": { "kind": "Name", "value": "scraperId" },
							"value": { "kind": "Variable", "name": { "kind": "Name", "value": "scraperId" } },
...
} as unknown as DocumentNode<GetLatestQuery, GetLatestQueryVariables>;
export const GetSearchScraperDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "GetSearchScraper" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "scraperId" } },
			"type": { "kind": "NonNullType", "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "String" } } },
...
} as unknown as DocumentNode<GetSearchScraperQuery, GetSearchScraperQueryVariables>;
export const GetTrendingDocument = {
	"kind": "Document",
	"definitions": [{
		"kind": "OperationDefinition",
		"operation": "query",
		"name": { "kind": "Name", "value": "GetTrending" },
		"variableDefinitions": [{
			"kind": "VariableDefinition",
			"variable": { "kind": "Variable", "name": { "kind": "Name", "value": "scraperId" } },
			"type": { "kind": "NonNullType", "type": { "kind": "NamedType", "name": { "kind": "Name", "value": "String" } } },
		...
		"selectionSet": {
			...
			"selections": [{
				...
				"selectionSet": {
					...
					"selections": [{
						"kind": "Field",
						"name": { "kind": "Name", "value": "scrapeTrending" },
						"arguments": [{
							"kind": "Argument",
							"name": { "kind": "Name", "value": "scraperId" },
							"value": { "kind": "Variable", "name": { "kind": "Name", "value": "scraperId" } },
...
} as unknown as DocumentNode<GetTrendingQuery, GetTrendingQueryVariables>;
/** All built-in and custom scalars, mapped to their actual values */
export type Scalars = {
	ID: { input: string; output: string };
	String: { input: string; output: string };
...
export function useGetFavoriteMangaQuery(options: Omit<Urql.UseQueryArgs<GetFavoriteMangaQueryVariables>, "query">) {
	return Urql.useQuery<GetFavoriteMangaQuery, GetFavoriteMangaQueryVariables>({
		query: GetFavoriteMangaDocument,
		...options,
	});
}
export const GetReadChaptersDocument = gql`
...
export function useGetReadChaptersQuery(options: Omit<Urql.UseQueryArgs<GetReadChaptersQueryVariables>, "query">) {
	return Urql.useQuery<GetReadChaptersQuery, GetReadChaptersQueryVariables>({ query: GetReadChaptersDocument, ...options });
}
...
export function useGetfavoriteMangasQuery(options: Omit<Urql.UseQueryArgs<GetfavoriteMangasQueryVariables>, "query">) {
	return Urql.useQuery<GetfavoriteMangasQuery, GetfavoriteMangasQueryVariables>({
		query: GetfavoriteMangasDocument,
		...options,
	});
}
...
export const ReadAllChaptersDocument = gql`
...
export function useReadAllChaptersMutation() {
	return Urql.useMutation<ReadAllChaptersMutation, ReadAllChaptersMutationVariables>(ReadAllChaptersDocument);
}
export const UnreadAllChaptersDocument = gql`
...
export function useUnreadAllChaptersMutation() {
	return Urql.useMutation<UnreadAllChaptersMutation, UnreadAllChaptersMutationVariables>(UnreadAllChaptersDocument);
}
...
export function useGetScrapersSearchQuery(options?: Omit<Urql.UseQueryArgs<GetScrapersSearchQueryVariables>, "query">) {
	return Urql.useQuery<GetScrapersSearchQuery, GetScrapersSearchQueryVariables>({
		query: GetScrapersSearchDocument,
		...options,
	});
}
...
export function useGetSearchScraperQuery(options: Omit<Urql.UseQueryArgs<GetSearchScraperQueryVariables>, "query">) {
	return Urql.useQuery<GetSearchScraperQuery, GetSearchScraperQueryVariables>({
		query: GetSearchScraperDocument,
		...options,
	});
}
