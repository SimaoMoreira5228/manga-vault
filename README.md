...
```json
{
	...
	"repositories": [{ "url": "https://raw.githubusercontent.com/SimaoMoreira5228/manga-vault/refs/heads/master/repo.json" }]
}
```
...
```json
{
	"Lua.workspace.library": ["/path/to/manga-vault/scrapers/scraper_core/types.lua"],
	"Lua.diagnostics.globals": ["http", "headless_client", "flaresolverr", "scraping"]
}
```
