...
async fn get_user_favorites(db: web::Data<connection::Connection>, user_id: web::Path<i32>) -> impl Responder {
	let favorite_mangas: Vec<crate::entities::favorite_mangas::Model> = crate::entities::favorite_mangas::Entity::find()
	...
	for favorite_manga in favorite_mangas {
		let manga: Option<crate::entities::mangas::Model> =
			crate::entities::mangas::Entity::find_by_id(favorite_manga.manga_id)
				.one(db.get_ref())
				.await
				.unwrap();
